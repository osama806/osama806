...
2. [Tasks-Management-Interfaces](https://github.com/osama806/Tasks-Management-Interfaces) ⭐
   - Description: MyTask Management Interfaces — web service built with PHP & MySQL; front-end interfaces using Blade templates. 

3. [Library-Management-System](https://github.com/osama806/Library-Management-System) ⭐
   - Description: RESTful PHP/MySQL service for borrowing/returning books and user ratings.
